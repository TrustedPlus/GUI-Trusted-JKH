export default {
  ...
  Settings: {
    settings: "Настройки",
    Settings: "НАСТРОЙКИ",
    cert_button: "Выбрать сертификат",  
    cert_block_title: "Сертификат информационной системы", 
    proxy_block_title: "Настройки прокси-сервера", 
    test_block_title: "Тестирование обмена с ГИС ЖКХ",   
    log_block_title: "Настройки журнала операций", 
    loglevel: "Уровень логирования:",  
    loglevel_choose: "Выберите уровень", 
    ...
    TRACE: "Информация трассировки", 
    ALL: "Логирование всего",
    clear_journal: "Очистить журнал",
    test_response: "Протестировать обмен",  
    encoding: "Кодировка",
  ...
  About: {
    ...
    about_programm: "Приложение Trusted ЖКХ предназначено для создания защищенного канала отправки запросов на портал ГИС ЖКХ и получения информации.",
    info_about_product: "Приложение Trusted ЖКХ предназначено для отправки пакетов документов и запросов на получение информации с портала ГИС ЖКХ (dom.gosuslugi.ru)",
    info_about_setting: "Установка параметров PROXY сервера для соединения с порталом ГИС ЖКХ", 
    info_about_journal: "Просмотр операций по отправке/приему сообщений",  
  ...
  Common: {
    tooltip_start: "Запуск прокси-сервера",  
    tooltip_stop: "Остановка прокси-сервера",   
    tooltip_restart: "Перезапуск прокси-сервера", 
    yes: "Да",
    no: "Нет",
    ...
    Back: "НАЗАД",
    serverStart: "СЕРВЕР ЗАПУЩЕН",
    serverStop: "СЕРВЕР ОСТАНОВЛЕН",
    serverRestart: "ПЕРЕЗАПУСК СЕРВЕРА ...",
