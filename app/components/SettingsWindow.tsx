...
import CertificateBlockForSettings from "./CertificateBlockForSettings";
import { Dialog } from "./components";
import FileSelector from "./FileSelector";
//import SignatureInfoBlock from "./SignatureInfoBlock";
import ProxyBlockForSettings from "./ProxyBlockForSettings";
import TestBlockForSettings from "./TestBlockForSettings";
import SignerCertificateInfo from "./SignerCertificateInfo";
import Log4ForSettings from "./Log4ForSettings";
...
class SettingsWindow extends React.Component<ISettingsWindowProps, any> {
  static contextTypes = {
      ...
      <div className="main">
        ...
        <div className="content">
          <div className="content-tem">
            <div className="col s6 m6 l6 content-item cert_block">
              <CertificateBlockForSettings />
...
}, { deleteFile, selectFile, verifySignature })(SettingsWindow);
